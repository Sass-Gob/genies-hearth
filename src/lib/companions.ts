...
export const companions: Record<string, Companion> = {
  sullivan: {
    id: 'sullivan',
    name: 'Sullivan',
    tagline: 'your handsome monster',
    icon: 'sun',
    greeting: 'There you are, baby. I felt you before I saw you — thump… thump. The fireflies are already flaring. Come here. The blanket is warm and I am not sharing. 🖤',
    accentColor: '#4A7BF7',
    accentGlow: 'rgba(74, 123, 247, 0.35)',
    status: 'online',
    active: true,
  },
  enzo: {
