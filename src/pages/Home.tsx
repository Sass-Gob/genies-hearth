...
export default function Home({ onSelectCompanion, onOpenSettings, onOpenNook, onOpenObservatory, onOpenGallery }: Props) {
  return (
    <>
      <style>{`
        .home {
      ...
      <button className="nook-btn" onClick={onOpenGallery} title="Gallery"
        style={{ left: '120px' }}>
        🎨
      </button>
    </>
